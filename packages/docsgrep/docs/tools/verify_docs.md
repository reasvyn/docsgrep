...
`verify_docs` acts as a linter for your documentation. It parses your Markdown files and compares them against the source code to ensure that every documented method and parameter is accurate. It helps prevent "documentation rot" by validating both existence and **function signatures**.
