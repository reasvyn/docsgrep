...
Unlike `search_docs`, which uses regex keyword matching, `semantic_search` understands natural language. It allows users to ask questions like "How do I handle authentication?" and finds relevant documentation even if the specific words don't match exactly.
