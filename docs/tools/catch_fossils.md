...
`catch_fossils` uses git history to find documentation that has become "fossilized" - meaning the related code has changed significantly but the documentation hasn't been touched. It helps prioritize which docs need the most urgent attention after a series of commits.
