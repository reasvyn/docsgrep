...
### Discovery & Setup
- [🏕️ `init_workspace`](tools/init_workspace.md) - Initialize workspace and .gitignore.
- [🕵️ `detect_stack`](tools/detect_stack.md) - Analyze project technology stack.
...
- [🛡️ `audit_security`](tools/audit_security.md) - OWASP, secrets, and privacy audit.
